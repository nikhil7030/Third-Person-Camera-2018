...
public class Water : MonoBehaviour
{
    ...
    [SerializeField] private Cubemap dayReflation;
    [SerializeField] private Cubemap nightReflation;
    ...
    public void ChangeReflection(bool dn)
    {
 
        if (dn)
        {
            
            rend.material.SetTexture("_Cube", nightReflation);

        }
        else if(!dn)
        {
            
            rend.material.SetTexture("_Cube", dayReflation);
